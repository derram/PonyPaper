...
- **Wait timer expired** + empty moving → stay waiting (re-roll timer; re-pick waiting). Does **not** fall through to invent travel. Legal on **looping** idles as well as one-shots.
